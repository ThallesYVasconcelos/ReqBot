...
| `cors.allowed-origins` / `CORS_ALLOWED_ORIGINS` | Não | Origens permitidas (separadas por vírgula). Para testar o frontend local contra a API no Cloud Run, inclua `http://localhost:4200`. Ex: `http://localhost:4200,https://seu-app.vercel.app` |
