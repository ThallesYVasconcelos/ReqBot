...
| `cors.allowed-origins` / `CORS_ALLOWED_ORIGINS` | Não | Origens permitidas (separadas por vírgula; ex: `https://seu-app.vercel.app`) |
...
CORS_ALLOWED_ORIGINS=https://seu-app.vercel.app  # opcional, para frontend em outro domínio
```
